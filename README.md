...
```bash
az ad sp create-for-rbac --name "GitHub-Actions-SP" --role contributor --scopes /subscriptions/dd627ee9-2a7b-4650-9ab6-6b4436401b7f --sdk-auth
```

### Apply to Custom Contributor Role
```bash
az ad sp create-for-rbac --name "GitHub-Actions-SP" --role 'infra_deploy' --scopes /subscriptions/dd627ee9-2a7b-4650-9ab6-6b4436401b7f --sdk-auth
```
...
az webapp deployment list-publishing-profiles --name redirect-api-dghqgdyt3wxkc --resource-group urlshortener-dev --xml
```